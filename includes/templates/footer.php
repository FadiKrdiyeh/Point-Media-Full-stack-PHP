...
<footer class="footer" id="footer">
                ...
                <div class="col-md-12 col-lg-8 mt-4">
                    <div class="row">
                        <div class="col-md-12 col-lg-5 mb-3">
                            <div class="content <?php echo $_COOKIE['language'] == "en" ? 'ps' : 'pe' ?>-5">
                                <span class="footer-icons">
                                    <i class="fa fa-phone"></i>
                                </span>
                                <span class="footer-info footer-info-number <?php echo $_COOKIE['language'] == "en" ? 'ms' : 'me' ?>-2">
                                    00963-980-5300-47
                                </span>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-7 mb-3">
                            <div class="content <?php echo $_COOKIE['language'] == "en" ? 'ps' : 'pe' ?>-5">
                                ...
                                <span class="footer-info <?php echo $_COOKIE['language'] == "en" ? 'ms' : 'me' ?>-2">
                                    <?php echo t("Odabaşı Mah. Mehmet Beyazıt Blok No: 11, iç kapı No: 5 Antakya/ Hatay"); ?>
                                </span>
                            </div>
                        </div>
                        <div class="col-12 mb-3">
                            <div class="content <?php echo $_COOKIE['language'] == "en" ? 'ps' : 'pe' ?>-5">
                                ...
                                <span class="footer-info footer-info-description <?php echo $_COOKIE['language'] == "en" ? 'ms' : 'me' ?>-2">
    ...
    <div class="footer-copy-right text-center"><?php echo t("All Copyright Reserved To "); ?> &copy; Point Media</div>
</footer>
<!-- jQuery -->
